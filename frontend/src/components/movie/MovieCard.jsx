    ...
    <Link to={`/${displayMediaType}/${id}`} className="group block perspective-1000">
      <div className="movie-card-hover relative overflow-hidden w-full max-w-[140px] sm:max-w-[160px] md:max-w-[180px] lg:max-w-[200px] mx-auto h-[240px] sm:h-[280px] md:h-[320px] lg:h-[360px] flex flex-col rounded-xl bg-gray-900/40 backdrop-blur-sm transition-all duration-500 ease-out group-hover:bg-gray-800/60 group-hover:shadow-2xl">
        ...
        <div className="relative w-full h-[190px] sm:h-[220px] md:h-[245px] lg:h-[270px] flex-shrink-0 overflow-hidden rounded-t-xl z-10">
          ...
          {ratingBadge && (
            <div
              className={`absolute top-2 sm:top-3 right-2 sm:right-3 flex items-center gap-0.5 sm:gap-1 ${ratingBadge.bgClass} backdrop-blur-md rounded-md sm:rounded-lg px-1.5 sm:px-2.5 py-1 sm:py-1.5 border ${ratingBadge.colorClass} font-bold text-[10px] sm:text-xs md:text-sm shadow-lg z-20`}
            >
        ...
        <div className="content-glow flex-1 flex flex-col justify-start p-2 sm:p-3 md:p-4 bg-gradient-to-b from-gray-800/50 to-gray-900/80 rounded-b-xl min-h-[50px] sm:min-h-[70px] md:min-h-[80px] lg:min-h-[90px] z-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {year && (
              <p className="text-[10px] sm:text-xs text-gray-400 font-medium group-hover:text-gray-300 transition-colors duration-300">
                {year}
              </p>
            )}
          </div>
